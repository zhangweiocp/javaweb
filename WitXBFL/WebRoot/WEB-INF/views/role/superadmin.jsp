      ...
      <div class="page-content">
         ...
         <div class="panel panel-success">
         	<div class="panel-heading">
         		<h3 class="panel-title">导入学生信息</h3>
         	</div>
			...
			<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-2 col-md-offset-5">${finish}</div>
					</div>
			</div>
			<div class="panel-footer">
	         	<div class="row">
		         	<div class="col-md-2 col-md-offset-5">
		         		<input type="submit" class="btn btn-success active" value="导入" />
		         	</div>
		        </div>
	        </div>
			</form>
         ...
         <div class="panel panel-success">
         	<div class="panel-heading">
         		<h3 class="panel-title">导出分流结果</h3>
         	</div>
         	<div class="panel-body">
         		<div class="row">
         			<div class="col-md-2 col-md-offset-5">
         	...
         	<div class="panel-footer">
         		<div class="row">
         			<div class="col-md-2 col-md-offset-5">
         				<input type="button" class="btn btn-success active" value="导出"/>
         			</div>
         		</div>
         	</div>
         </div>
         <!--<div class="row">将学生信息导入数据库</div>
         <form action="upload.action" method="post" enctype="multipart/form-data">
         <div class="row">
         <input type="file" name="file">
         <input class="btn btn-success avtive" type="submit" value="提交">
         </div>
         </form>
         <div class="row">
         	结果:${finish}
